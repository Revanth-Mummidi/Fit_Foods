...
function FoodItemScreen() {
  ...
  return (
    <div className="h-screen w-screen flex items-center justify-center p-10 bg-gradient-to-r from-black to-gray-800">
      {!isLoading?(<div className="flex flex-col gap-4 items-center p-10  w-full md:w-[50vw] h-[90vh] max-w-[900px] bg-white overflow-y-scroll overflow-x-scroll rounded-lg shadow-md shadow-slate-100">
        <img
          src={item?.image}
          className="w-[290px] aspect-video bg-black object-fit"
          alt="Food Item"
        />
